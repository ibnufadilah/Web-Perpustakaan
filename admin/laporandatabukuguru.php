...
if(isset($_POST['submit'])){
        ...
        $sql = mysqli_query($koneksi,"select * from data_bukuguru where tgl_penerima='$tgl'"); 
        }
        else{
           $sql = mysqli_query($koneksi,"select * from data_bukuguru "); 
        }
  ...
  <table id="table" class="table table-bordered">
    <thead class="thead-dark">
      ...
      <th>No.</th>
        ...
        $sql = mysqli_query($koneksi, "SELECT * FROM data_bukuguru ") or die(mysqli_error($koneksi));
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="post" action="cetaklaporanbukuguru.php" target="_blank">
                <label>PILIH TANGGAL</label>
                <input type="date" name="tgl_penerima">
      </div>
