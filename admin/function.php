<?php
  ...
  $query = "INSERT INTO data_bukuguru VALUES ('','$no_buku', '$tgl_penerima', '$no_invetaris', '$judul', '$pengarang', '$penerbit', '$jumlah', '$jenis', '$bahasa', '$asal', '$keterangan')";
  ...
  $bahasa      = mysqli_real_escape_string($conn, $data["bahasa"]);
   ...
   $query = "INSERT INTO data_bukuguru VALUES ('','$no_buku', '$tgl_penerima', '$no_invetaris', '$judul', '$pengarang', '$penerbit', '$jumlah', '$jenis', '$bahasa')";
  mysqli_query($conn, $query);
