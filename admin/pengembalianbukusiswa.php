...
<br>
  ...
  <table id="table" class="table table-bordered">
   ...
   $no = 1;
   $nisn = $cust['nisn']; 
   $baca= "SELECT * FROM pengembalian_siswa";
   ...
   if (mysqli_num_rows($tampil)>0) {
    ...
    <td><a class='btn btn-danger' href=delete_kembalibukusiswa.php?id_kembalisiswa=$row[id_kembalisiswa]> Delete</a><br><br>
                 </td>
