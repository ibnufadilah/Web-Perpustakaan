...
if(isset($_POST['submit'])){
        ...
        $sql = mysqli_query($koneksi,"select * from pengembalian_guru where tgl_kembali='$tgl'"); 
        }
        else{
           $sql = mysqli_query($koneksi,"select * from pengembalian_guru "); 
        }
...
<br>
<br>
<h2> LAPORAN PENGEMBALIAN BUKU GURU </h2>
 <!--  <div class="col-md-4">
  <br>
    ...
    <thead class="thead-dark">
      <tr>
       ...
       <th>Jumlah</th>
        ...
        $sql = mysqli_query($koneksi, "SELECT * FROM pengembalian_guru ") or die(mysqli_error($koneksi));
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="post" action="cetaklaporanpengembalianguru.php" target="_blank">
