...
if(isset($_POST['submit'])){
        ...
        $sql = mysqli_query($koneksi,"select * from peminjaman_guru where tgl_pinjam='$tgl'"); 
        }
        else{
           $sql = mysqli_query($koneksi,"select * from peminjaman_guru "); 
        }
...
<br>
<br>
<h2> LAPORAN PEMINJAMAN BUKU GURU </h2>
 <!--  <div class="col-md-4">
  <br>
    ...
    <thead class="thead-dark">
      <tr>
       ...
       <th>status</th>
        ...
        $sql = mysqli_query($koneksi, "SELECT * FROM peminjaman_guru ") or die(mysqli_error($koneksi));
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="post" action="cetaklaporanpinjamguru.php" target="_blank">
