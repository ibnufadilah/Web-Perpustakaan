...
<div class="container">
   ...
   <?php            
        ...
        $baca= "SELECT * FROM data_bukuguru where id_bukuguru='$_GET[id_bukuguru]'";
  ...
  <div class="card-body"><h2></div>
    <h2>Input Data Buku Perpustakaan</h2>
      <p>semangat & selamat bekerja :)</p>
        <br>
            <form action="proses_editguru.php" method="POST" class="col-ms-11">
              <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $row['id_bukuguru'] ?>" />
