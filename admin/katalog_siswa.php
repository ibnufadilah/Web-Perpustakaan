    ...
    <thead class="thead-dark">
      <tr>
       <th>No.</th>
                ...
                <th>Keterangan</th>
                <th>Opsi</th>
              <a href="formdatabukusiswa.php" type="button" class="btn btn-primary">Tambah Buku</a>
              ...
              <td>
               ...
               <td>$row[no_buku] </td>
                ...
                <td>$row[keterangan]</td>
                 <td><a class='btn btn-danger' href=delete.php?id_bukusiswa=$row[id_bukusiswa]> Delete</a><br><br><a class='btn btn-primary' href=form_edit.php?id_bukusiswa=$row[id_bukusiswa]> Edit</a><br><br>
                  <button type='button' class='btn btn-success' data-toggle='modal' data-target='#pinjam-$row[id_bukusiswa]'>
      Pinjam </button>
                 </td>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="email" name="nisn" placeholder="Masukkan NISN Peminjam">
              </div>
               <div class="form-group">
                <label for="email">Nama Siswa :</label>
                <input type="text" class="form-control" id="email" name="nama_siswa" placeholder="Masukkan Nama Peminjam">
              </div>
              <div class="form-group">
