...
<br>
  ...
  <table id="table" class="table table-bordered">
   ...
   $baca= "SELECT * FROM peminjaman_guru order  by id_pinjamguru ASC";
   ...
   if (mysqli_num_rows($tampil)>0) {
    ...
    <td>
       ...
       <a href="kembali_bukuguru.php?id_pinjamguru=<?php echo  $row['id_pinjamguru']; ?>" class="btn btn-primary"> Kembalikan Buku </a> <br><br>
                 </td><?php }
      ...
      <td>
       <a class='btn btn-danger' href=delete_pinjamguru.php?id_pinjamguru=$row[id_pinjamguru]> Delete</a><br><br></td>       
