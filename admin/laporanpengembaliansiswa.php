...
if(isset($_POST['submit'])){
        ...
        $sql = mysqli_query($koneksi,"select * from pengembalian_siswa where tgl_kembali='$tgl'"); 
        }
        else{
           $sql = mysqli_query($koneksi,"select * from pengembalian_siswa "); 
        }
...
<br>
<br>
<h2> LAPORAN PENGEMBALIAN BUKU SISWA </h2>
 <!--  <div class="col-md-4">
  <br>
    ...
    <thead class="thead-dark">
      <tr>
       ...
       <th>telat</th>
        ...
        $sql = mysqli_query($koneksi, "SELECT * FROM pengembalian_siswa ") or die(mysqli_error($koneksi));
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="post" action="cetaklaporanpengembaliansiswa.php" target="_blank">
