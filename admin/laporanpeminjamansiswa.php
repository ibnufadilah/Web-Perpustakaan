...
if(isset($_POST['submit'])){
        ...
        $sql = mysqli_query($koneksi,"select * from peminjaman_siswa where tgl_pinjam='$tgl'"); 
        }
        else{
           $sql = mysqli_query($koneksi,"select * from peminjaman_siswa "); 
        }
...
<br>
<br>
<h2> LAPORAN PEMINJAMAN BUKU SISWA </h2>
 <!--  <div class="col-md-4">
  <br>
    ...
    <thead class="thead-dark">
      <tr>
       ...
       <th>Status</th>
        ...
        $sql = mysqli_query($koneksi, "SELECT * FROM peminjaman_siswa ") or die(mysqli_error($koneksi));
