  ...
  if (isset($_POST["buku"])) {
    if (buku($_POST) > 0) {
      echo "<script>
          ...
          document.location.href = 'katalog_siswa.php';
          </script>";
    } else {
  ...
  <div class="card-body"><h2></div>
    <h2>Input Data Buku Perpustakaan</h2>
      <p>semangat & selamat bekerja :)</p>
        <br>
            <form action="" method="POST" class="col-ms-11">
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control" id="tgl_penerima" name="tgl_penerima">
              </div>
              <div class="form-group">
                <label for="no_invetaris">No Inventaris :</label>
                <input type="text" class="form-control" id="no_invetaris" name="no_invetaris">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <select id="asal" class="form-control form-control-sm" name="asal">
                  ...
                  <option selected>Bos Pusat</option>
                  <option selected>Bos Reguler</option>
                  <option selected>Bos Provinsi</option>
                  <option selected>SMAN 1 Klapanunggal</option>
                  <option selected>Penerbit</option>
                  <option selected>MUI.Kab Bogor</option>
                </select>
                </div>
              <div class="form-group">
