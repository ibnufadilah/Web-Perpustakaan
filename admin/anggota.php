...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-light">
  <a class="navbar-brand text-light" href="#">SIPS SMANNUNGAL</a>
    ...
    <thead class="thead-dark">
      <tr>
       <th>No.</th>
                ...
                <th>Alamat</th>
                <th>Opsi</th>
                <a href="register.php" type ="button" class="btn btn-primary">Tambah Member</a>
            ...
            <tr>
              <td>'.$no.'</td>
               <td>'.$row[nisn].'</td>
                ...
                <td>'.$row[no_telp].'</td>
                <td>'.$row[alamat].'</td>
                 <td><a class="btn btn-danger" href=deleteanggota.php?id_siswa='.$row[id_siswa].'> Delete</a><br><br><a class="btn btn-primary" href=form_editanggota.php?id_siswa='.$row[id_siswa].'> Edit</a><br><br>
